...
-- and then feed the data into other tables. Table's name is Input_Data. We use SSMS to automatically create the table and columns from given Excel file.
...
INSERT INTO Stocks
    (symbol, name, sector_id, exchange)
SELECT DISTINCT
    i.Ticker,
    i.Company_Name,
    s.sector_id,
